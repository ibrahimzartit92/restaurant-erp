...
export enum BankAccountTransactionType {
  ...
  EmployeeDebtBank = 'employee_debt_bank',
  EmployeeObligationRepaymentBank = 'employee_obligation_repayment_bank',
  EmployeeObligationReversalBank = 'employee_obligation_reversal_bank',
