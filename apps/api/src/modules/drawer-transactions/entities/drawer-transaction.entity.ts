...
export enum DrawerTransactionType {
  ...
  EmployeeDebtCash = 'employee_debt_cash',
  EmployeeObligationRepaymentCash = 'employee_obligation_repayment_cash',
  EmployeeObligationReversalCash = 'employee_obligation_reversal_cash',
  PayrollPaymentCash = 'payroll_payment_cash',
  WholesaleSalesCashCollection = 'wholesale_sales_cash_collection',
