...
import type { BranchOption, ItemOption, SupplierOption, WarehouseOption } from '../../../lib/types';

export default async function NewPurchaseInvoicePage() {
  const [branches, warehouses, suppliers, items] = await Promise.all([
  ...
  return (
    <>
      ...
      <PurchaseInvoiceForm branches={branches.data} warehouses={warehouses.data} suppliers={suppliers.data} items={items.data} />
    </>
  );
}
